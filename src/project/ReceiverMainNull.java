...
public class ReceiverMainNull extends Frame {
	public void doJob()throws IOException, UnsupportedCommOperationException, PortInUseException, NoSuchPortException{
		...
		GBNReceiveNull receiving = new GBNReceiveNull();
		//receiving.goRun();
